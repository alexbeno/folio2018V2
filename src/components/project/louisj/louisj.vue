    ...
    <div class="details">
      <div class="details__container" v-if="mobile === false">
        <div class="details__container__video details__container__video--1">
          <video class="details__container__video__content" src="@/../static/video/louisj/home.mp4" autoplay loop muted></video>
        </div>
        <div class="details__container__video details__container__video--2">
          <video class="details__container__video__content" src="@/../static/video/louisj/musique.mp4" autoplay loop muted></video>
        </div>
        <div class="details__container__video details__container__video--2">
          <video class="details__container__video__content" src="@/../static/video/louisj/insta.mp4" autoplay loop muted></video>
        </div>
      </div>
    </div>
